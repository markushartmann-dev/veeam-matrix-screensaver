...
| Version | Highlights |
|---|---|
| **v1.85–v1.86** | CRAWL font and intro phase now fully respect Bold / Italic settings (were hardcoded) |
| **v1.81–v1.84** | **Settings Profiles** (save/load full settings as `.ini`); Credits popup with LinkedIn, Blog & GitHub links; cinema letterbox bars on both banners; mode buttons (DE+EN); UI 5% shorter; Term Catalog dark/light mode |
