...
| **Color profiles & picker** | 7 built-ins (Veeam, Cyberpunk, Amber CRT, Deep Space, Aurora, Star Wars, Hello Kitty) + 2-button color picker — applies to all layers at once |
| **Veeam Vanguard / Legend / MVP** | **100+ community member names** cascade across the screen — fully randomised, different on every monitor |
