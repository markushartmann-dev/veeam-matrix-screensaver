    ...
    class ConfigForm : Form
    {
        ...
        private void Build()
        {
            ...
            btnCredits.Click += delegate {
                ...
                var dC = new Form { Text = T("Credits","Credits"), Size = new Size(380,225),
                ...
                var lC = new LinkLabel {
                    ...
                    Location = new Point(16,10), Size = new Size(318,118),
                ...
                // "Markus Hartmann" = plain text, no link
                int p2 = lC.Text.IndexOf("linkedin.com/in/markus-hartmann-28311232");
                int p3 = lC.Text.LastIndexOf("markushartmann.blog");
                int p4 = lC.Text.LastIndexOf("github.com/markushartmann-dev");
                lC.Links.Add(new LinkLabel.Link(p2, "linkedin.com/in/markus-hartmann-28311232".Length, "https://www.linkedin.com/in/markus-hartmann-28311232/"));
                lC.Links.Add(new LinkLabel.Link(p3, "markushartmann.blog".Length,                      "https://markushartmann.blog"));
                lC.Links.Add(new LinkLabel.Link(p4, "github.com/markushartmann-dev".Length,            "https://github.com/markushartmann-dev"));
                ...
                var bOkC = new Button { Text = "OK", DialogResult = DialogResult.OK,
                    Location = new Point(270,140), Size = new Size(80,28),
                    FlatStyle = FlatStyle.Flat,
