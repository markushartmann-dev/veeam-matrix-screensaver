    ...
    class ConfigForm : Form
    {
        ...
        private void Build()
        {
            ...
            btnCredits.Click += delegate {
                ...
                var dC = new Form { Text = T("Credits","Credits"), Size = new Size(390,240),
                ...
                int p3 = lC.Text.IndexOf("markushartmann.blog");
                int p4 = lC.Text.IndexOf("github.com/markushartmann-dev");
                ...
                var bOkC = new Button { Text = "OK", DialogResult = DialogResult.OK,
                    Location = new Point(285,155), Size = new Size(80,28),
                    FlatStyle = FlatStyle.Flat,
